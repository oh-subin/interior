										...
										<div class="form-row">
											<div class="form_colum">
												<select class="nc_select">
													...
													<option name="아파트">아파트</option>
													<option name="원룸&오피스텔">원룸&오피스텔</option>
													<option name="빌라&연립">빌라&연립</option>
													<option name="단독주택">단독주택</option>
												</select>
											</div>
											<div class="form_colum">
												<select class="nc_select">
													<option selected>평수</option>
													<option name="10평대">10평대</option>
													<option name="10평 미만">10평 미만</option>
													<option name="20평대">20평대</option>
													<option name="30평대">30평대</option>
													<option name="40평대">40평대</option>
													<option name="50평대 이상">50평대 이상</option>
												</select>
											</div>
											<div class="form_colum"  style="margin-right: 290px">
												<select class="nc_select">
													<option selected>가족형태</option>
													<option name="싱글라이프">싱글라이프</option>
													<option name="신혼부부">신혼부부</option>
													<option name="신혼부부, 아기가 있는 집">신혼부부, 아기가 있는 집</option>
													<option name="아기가 있는 집">아기가 있는 집</option>
													<option name="부모님과 함께 사는 집">부모님과 함께 사는 집</option>
													<option name="아기가 있는 집, 취약 자녀가 있는 집">아기가 있는 집, 취약 자녀가 있는 집</option>
													<option name="취약 자녀가 있는 집">취약 자녀가 있는 집</option>
												</select>
											</div>
											<div class="form_btn">
               ...
               <div class="row gallery-item">
                   ...
                   <div class="col-md-6">
                       <a href="img/homepage/10.jpg" class="img-pop-up">
                           ...
                           <label><input type="radio" name="tag" value="1"> 1</label>
      						<label><input type="radio" name="tag" value="2"> 2</label>
      						<label><input type="radio" name="tag" value="3"> 3</label>
      						<label><input type="radio" name="tag" value="4"> 4</label>
      						<label><input type="radio" name="tag" value="5"> 5</label>
