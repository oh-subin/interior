			...
			<div class="jbMenu" style="height: 100px;">
				...
				<div class="jbMenu" style="height: 100px;">
					...
					<div style="width: 600px; margin-left: 500px; height: 20px;">
						<div style="width: 600px; height: 20px;">
							<b class="prograss_text">추천 진행도<b
								style="padding-left: 440px;">0%</b></b>
...
=======
 <!-- prograss bar end  -->
												...
												<section class="booking_part"
													...
													<div class="container">
														<div class="row">
															<div class="col-lg-12">
																<div class="booking_menu">
																	<h2 style="color: #012a4a; font-size: 40px;">1. 태그
																		선택</h2>
																	<br>
																	<p
																		style="color: #01497c; font-size: 20px; background-color: #e2eafc;">인테리어
																		추천을 위해 아래의 태그를 선택해주세요.</p>
																					...
																					<div class="form-row">
																						...
																						<div class="form_colum"
																							...
																							<select class="nc_select"
																								name="select_familyShape">
																								<option selected>가족형태</option>
																								<option value="싱글라이프">싱글라이프</option>
																								<option value="신혼부부">신혼부부</option>
																								<option value="신혼부부, 아기가 있는 집">신혼부부,
																									아기가 있는 집</option>
																								<option value="아기가 있는 집">아기가 있는 집</option>
																								<option value="부모님과 함께 사는 집">부모님과 함께 사는
																									집</option>
																								<option value="아기가 있는 집, 취약 자녀가 있는 집">아기가
																									있는 집, 취약 자녀가 있는 집</option>
   ...
   <form action="SecondRecommendation" method="post">
	...
	<br>
	<div
		style="background: url(img/homepage/text_img.JPG); width: 1200px; height: 150px; margin-left: 200px; background-repeat: no-repeat;"></div>
	<br>
	<br>
