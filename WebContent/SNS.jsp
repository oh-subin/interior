                ...
                <div class="col-lg-12">
                    <div class="breadcrumb_iner">
                        <div class="breadcrumb_iner_item text-center">
                            <h2>Homekit Combination</h2>
                            <p style="padding-bottom: 80px;">홈키트로 새로운 조합을 만들 수 있습니다.</p>
                        </div>
                    </div>
                </div>
            </div>
...
<!-- 홈키트 조합하면 생성할 페이지(고도화 단계라서 아직 수정전임-> 수정 후에 주석 변경할 것!) -->
    <!--================Blog Area =================-->
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 posts-list">
                    ...
                    <!-- 수정: 홈키트 조합 만든 것 올리는 부분 begin -->
                    <div class="comment-form">
                        <h4>내가 만든 새로운 홈키트 자랑하기</h4>
                        <form class="form-contact comment_form" action="#" id="commentForm">
                            ...
                            <div class="form-group">
                                <button type="submit" class="button button-contactForm btn_1">자랑하기</button>
                            </div>
                        </form>
                    </div>
                </div>
                <!-- 수정: 홈키트 조합 만든 것 올리는 부분 end -->
